          ...
          <div class="row-fluid">
            <ul class="thumbnails">
                <li class="span8">
                    ...
                    <i class="icon-check-empty"> </i> Berita Tidak Ada
                    </p>
                    
                    <a href="<?php echo base_url();?>index.php/user"><button class="btn btn-small">Beranda</button></a>
                    <?php
                    }else{
                    ?>
                    <?php
                ...
                <article class="post-row article">
                    <h3><a href=""><?php echo $bb->judul;?></a></h3>
                </p>
