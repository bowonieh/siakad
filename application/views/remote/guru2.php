              ...
              foreach($isi as $bb){
                ...
                <div class="thumbnail">
                  ...
                  if (empty($bb->foto)){
                    ...
                    echo base_url().'img/upload/icon-user.png';
                    
                  }else{
                  
                  echo base_url();echo 'img/upload/'.$bb->foto;
                  }?>" alt="<?php echo $bb->nama_guru;?>" height="50" width="200"/>
                  <div class="caption">
                      <?php if(empty($bb->nama_guru)){
                          ?>
                      <h4>Data Kosong</h4>
                      <?php 
                      }else{
                          ?>
                      <h6><a href="<?php echo base_url();?>index.php/guru/detilguru/<?php echo $bb->id_guru;?>"><?php echo $bb->nama_guru;?></a></h>
                      <?php 
                      }
                    ?>
                    <p>
                        <!-- <i class="icon-star"></i> <?php echo $bb->tempat;?>,<?php echo $bb->tgl_lahir;?></p>
                        <i class="icon-thumbs-up"></i>NUPTK : <?php echo $bb->nuptk;?>-->
                    </p>
                  </div>
                  <!--
