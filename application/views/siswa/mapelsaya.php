                    ...
                    foreach($isi as $bb){
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url();?>index.php/siswa/keluar/<?php echo $bb->id;?>" data-confirm="Keluar Mata Pelajaran <?php echo $bb->mapel;?>?">
                                    
                                        <button class="btn btn-danger"><i class="icon-edit icon-white"></i> Keluar</button>
