<div class="content">
      ...
      <!-- Start: PRODUCT LIST -->
        ...
        <div class="form-group">
            <legend><i class="icon-plus-sign"></i> Edit Mata Pelajaran</legend>
            <label class="control-label" for="input01">Kode Mata Pelajaran <font color="red">*</font></label>
            <div class="controls">  
              <input type="text" class="form-control" id="disabledInput" name="kode_mapel" value="<?php echo $row->kode_mapel; ?>" >  
              </p>
            </div>
            <label class="control-label" for="input02">Nama Mata Pelajaran<font color="red">*</font></label>
            <div class="controls">  
              <input type="text" class="input-xlarge" id="input02" name="mapel" value="<?php echo $row->mapel; ?>">
            ...
            <div class="controls">  
                <input type="text" class="input-small" id="input02" name="kkm" value="<?php echo $row->kkm; ?>">
              </p>
            </div>
            
            <label class="control-label" for="input06">Deskripsi<font color="red">*</font></label>
            <div class="controls">  
                <textarea class="textarea" id="wysiwyg" name="deskripsi" style="width:100%;" placeholder="Deskripsi"><?php echo $row->deskripsi ?></textarea>
            </p>
            </div>
            ...
            <button class="btn" type="button" onclick="history.go(-1);">Batal</button>  
          </div>
