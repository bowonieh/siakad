      ...
      <!-- Start: PRODUCT LIST -->
        <div class="container">
          <div class="page-header">
            <h2>Daftar Guru</h2></p>
          <a href="<?php echo base_url();?>index.php/guru/tambahguru" ><button class="btn btn-success" data-confirm="Hapus Data Guru?"><i class="icon-plus-sign icon-white"></i> Tambah</button></a>
          </div>
          <div class="row-fluid">
            <ul class="thumbnails">
                ...
                <li class="span8">
                    ...
                    ?>
                    <table class="table table-hover table-bordered table-striped" id="t12">
                        <thead>
                        <th>NO</th>
                        <th>NAMA GURU</th>
                        <th>Username</th>
                    ...
                    foreach($isi as $bb){
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url();?>index.php/guru/hapusguru/<?php echo $bb->id_guru;?>"><button class="btn btn-primary" >Hapus</button></a></td>
                            </tr>
                    <?php
                        }
                    }
